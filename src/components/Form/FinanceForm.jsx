...
export function FinanceForm() {
    const formInputs = [
        { label: "Full Name", id: "fullName", placeholder: "Value" },
        { label: "Email", id: "email", type: "email", placeholder: "Value" },
        { label: "Phone", id: "phone", type: "tel", placeholder: "Value" },
        { label: "Company", id: "company", placeholder: "Value" }
    ];
